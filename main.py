...
new_x_test = np.divide(new_x_test, args.fold_number)
new_y_test = np.divide(new_y_test, args.fold_number)
np.savetxt('results/new_x_train.csv', new_x_train, delimiter=',')
np.savetxt('results/new_y_train.csv', new_y_train, delimiter=',')
np.savetxt('results/new_x_test.csv', new_x_test, delimiter=',')
np.savetxt('results/new_y_test.csv', new_y_test, delimiter=',')
